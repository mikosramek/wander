...
function ThoughtForm() {
  ...
  const resultText = result ? (
    ...
    <span className="eventPlaceholder">result</span>
  );
  const action1Text = action1 ? (
    <span className="action"> {action1} </span>
  ) : (
    <span className="eventPlaceholder">firstAction</span>
  );
  const action2Text = action2 ? (
    <span className="action"> {action2} </span>
  ) : (
    <span className="eventPlaceholder">secondAction</span>
  );
  const eventText = event ? (
    <span className="event"> {event} </span>
  ) : (
    <span className="eventPlaceholder">an upcoming event</span>
  );
        ...
        >
          <section className="page">
            <p className="solo-title">
              ...
              <span className="line-space">What are you worried about</span> the
              most right now?
            </p>
          ...
          <section className="thoughts page">
            ...
            <form className="thoughtForm">
              ...
              <p className="prompt">
                Do these happen often in this situational context?
              </p>
              <textarea
                name=""
          ...
          <section className="thoughts page">
            ...
            <form className="thoughtForm">
              ...
              <p className="prompt">
                Define "{resultText}". What does it mean for {event}?
              </p>
              <textarea
                name=""
          ...
          <section className="thoughts page">
            ...
            <form className="thoughtForm">
              ...
              <p className="prompt">
                If you can, think back to the times you experienced this.{" "}
                <span className="line-space">
                  On average, how long were you affected by them for?
                </span>
              </p>
              ...
              <div className="lineFlex timeSelect">
                ...
                <select name="counter" id="counter">
                  <option
                    value="Hours"
                    defaultValue={effectTimeUnit === "Hours"}
                    onChange={(e) => {
                      setEffectTimeUnit(e.target.value);
                    }}
                  >
                    Hours
                  </option>
                  <option
                    value="Days"
                    defaultValue={effectTimeUnit === "Days"}
                    onChange={(e) => {
                      setEffectTimeUnit(e.target.value);
                    }}
                  >
                  ...
                  <option
                    value="Weeks"
                    defaultValue={effectTimeUnit === "Weeks"}
                    onChange={(e) => {
                      setEffectTimeUnit(e.target.value);
                    }}
                  >
                  ...
                  <option
                    value="Months"
                    defaultValue={effectTimeUnit === "Months"}
                    onChange={(e) => {
                      setEffectTimeUnit(e.target.value);
                    }}
                  >
                  ...
                  <option
                    value="Years"
                    defaultValue={effectTimeUnit === "Years"}
                    onChange={(e) => {
                      setEffectTimeUnit(e.target.value);
                    }}
                  >
          ...
          <section className="thoughts page">
            <p className="solo-title">
              Now, let’s think about something more honest and manageable.
            </p>
            <ScrollButton enabled text="Next" scroll={nextPage} />
          </section>
          ...
          <section className="RFpage">
            ...
            <p className="RFtitle">
              <span className="line-space">What would be the more</span> likely
              to happen?
            </p>

            <form className="RFthoughtForm">
              <label htmlFor="rfaction1">
                Worrying about {`${event}`} makes me feel uncomfortable. But to
                try my best to get through it, I will
              </label>
              ...
              <label htmlFor="gain">
                And it's okay even if it ends up being {`${result}`}, because
                I'll gain
              </label>
              <input
                className="gain"
              ...
              <label htmlFor="rfmitigation">
                I'll help myself feel better by
              </label>
              <input
                className="rfmitigation"
                type="text"
                id="rfmitigation"
                value={rfmitigation}
                onChange={(e) => {
                  setRFmitigation(e.target.value);
                }}
              ...
              <ScrollButton
                className="RFbutton"
                enabled={rfaction1 && gain && rfmitigation}
                text="Next"
                scroll={nextPage}
              />
            </form>
          ...
          <section className="thoughts page receipt">
            <div className="ticket">
              <p>
                This event usually affects me for {effectTime} {effectTimeUnit}.
              </p>
              <div className="dotted-line"></div>
              <p className="accent">
                <span>{action1}</span>
